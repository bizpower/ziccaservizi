...
import { adminDeleteSector, adminListSectors, adminSaveSector } from "@/lib/content.functions";
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-[11px] text-muted-foreground mt-0.5">
                  /{s.slug} · ordine {s.sort_order}
                </div>
              </div>
              <span
                className={`text-xs px-2 py-1 rounded-full inline-flex items-center gap-1 ${s.published ? "bg-electric/10 text-electric" : "bg-muted text-muted-foreground"}`}
              >
          ...
          <div className="bg-background rounded-2xl border border-border max-w-2xl w-full p-6 my-8">
            <div className="flex items-center justify-between mb-6">
              <h2 className="font-display text-xl font-bold">
                {editing.id ? "Modifica settore" : "Nuovo settore"}
              </h2>
              <button
